...
@synthesize suit = _suit; //we must synthesize this property because we are declaring both getter and setter methods.

// overriding match: method
// implemented so that it doesn't matter how many cards should be matched
- (int)match:(NSArray *)otherCards
{
    ...
    // if there are cards to be matched, match them
